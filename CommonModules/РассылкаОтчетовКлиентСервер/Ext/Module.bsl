...
Функция РазобратьFTPАдрес(ПолныйFTPАдрес) Экспорт
	...
	// Вырезать "ftp<<ВНЕШНЕЕСОЕДИНЕНИЕ>>".
...
Функция ШаблонТемы() Экспорт
	Возврат НСтр("ru = '[НаименованиеРассылки] от [ДатаВыполнения(ДЛФ=''D'')]'; en = '[НаименованиеРассылки] от [ДатаВыполнения(ДЛФ=''D'')]'");
КонецФункции
...
Функция ШаблонИмениАрхива() Экспорт
	...
	Возврат НСтр("ru = '[НаименованиеРассылки]_[ДатаВыполнения(ДФ=''yyyy-MM-dd'')]'; en = '[НаименованиеРассылки]_[ДатаВыполнения(ДФ=''yyyy-MM-dd'')]'");
КонецФункции
...
Функция СписокВариантовЗаполненияРасписаний() Экспорт
	...
	СписокВариантов.Добавить(1, НСтр("ru = 'Каждый день'; en = 'Every day'"));
	...
	СписокВариантов.Добавить(6, НСтр("ru = 'По понедельникам'; en = 'On Monday'"));
	СписокВариантов.Добавить(7, НСтр("ru = 'По пятницам'; en = 'On Friday'"));
	СписокВариантов.Добавить(8, НСтр("ru = 'По воскресеньям'; en = 'On Sunday'"));
	...
	СписокВариантов.Добавить(11, НСтр("ru = 'Каждый квартал десятого числа'; en = 'Each quarter the tenth number'"));
...
Функция СтрокаСообщенийПользователю(МассивОшибок = Неопределено, ДобавитьДежурнуюФразу = Истина) Экспорт
	...
	Если ВсеОшибки <> "" И ДобавитьДежурнуюФразу Тогда
		ВсеОшибки = ВсеОшибки + Отступ + "---" + Отступ + НСтр("ru = 'Подробности см. в журнале регистрации.'; en = 'For details, see the event log.'");
	КонецЕсли;
...
Функция ПредставлениеСпособовДоставки(ПараметрыДоставки) Экспорт
	Префикс = НСтр("ru = 'Результат'; en = 'Result'");
	ТекстПредставления = "";
	Суффикс = "";
	...
	Если Не ПараметрыДоставки.ТолькоУведомить Тогда
		...
		+ ?(ТекстПредставления = "", Префикс, " " + НСтр("ru = 'и'; en = 'and'")) 
		+ " "
		+ НСтр("ru = 'отправлен по почте (см. вложения)'; en = 'mailed (see attachments)'");
	...
	Если ПараметрыДоставки.ВыполненаВПапку Тогда
		...
		+ ?(ТекстПредставления = "", Префикс, " " + НСтр("ru = 'и'; en = 'and'")) 
		+ " "
		+ НСтр("ru = 'доставлен в папку'; en = 'delivered to a folder'")
		+ " ";
	...
	Если ПараметрыДоставки.ВыполненаВСетевойКаталог Тогда
		...
		+ ?(ТекстПредставления = "", Префикс, " " + НСтр("ru = 'и'; en = 'and'")) 
		+ " "
		+ НСтр("ru = 'доставлен в сетевой каталог'; en = 'delivered in a network directory'")
		+ " ";
	...
	Если ПараметрыДоставки.ВыполненаНаFTP Тогда
		...
		+ ?(ТекстПредставления = "", Префикс, " " + НСтр("ru = 'и'; en = 'and'")) 
		+ " "
		+ НСтр("ru = 'доставлен на FTP ресурс'; en = 'delivered on an FTP resource'")
		+ " ";
