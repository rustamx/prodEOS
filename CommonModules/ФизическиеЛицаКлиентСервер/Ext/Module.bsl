...
Функция ЧастиИмени(ФамилияИмяОтчество) Экспорт
	...
	Если ЧастиИмени.Количество() > 3 Тогда
		...
		ДополнительныеЧастиОтчества.Добавить(НСтр("ru = 'оглы'; en = 'оглы'"));
		ДополнительныеЧастиОтчества.Добавить(НСтр("ru = 'улы'; en = 'улы'"));
		ДополнительныеЧастиОтчества.Добавить(НСтр("ru = 'уулу'; en = 'уулу'"));
		ДополнительныеЧастиОтчества.Добавить(НСтр("ru = 'кызы'; en = 'кызы'"));
		ДополнительныеЧастиОтчества.Добавить(НСтр("ru = 'гызы'; en = 'гызы'"));
