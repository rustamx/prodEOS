...
Функция ПредставлениеСертификата(Сертификат, Отчество = Ложь, СрокДействия = Истина) Экспорт
	...
	Возврат ПредставлениеСубъекта(Сертификат, Отчество) + ", "
		+ СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru = 'до %1'; en = 'to %1'"), Формат(Сертификат.ДатаОкончания, "ДФ=MM.yyyy"));
...
Функция ЗаполнитьОписаниеДанныхСертификата(Таблица, Сертификат) Экспорт
	...
	Если ДляПодписи И ДляШифрования Тогда
		Назначение = НСтр("ru = 'Подписание данных, Шифрование данных'; en = 'Signing data, data encryption'");
		
	ИначеЕсли ДляПодписи Тогда
		Назначение = НСтр("ru = 'Подписание данных'; en = 'Signing data'");
	Иначе
		Назначение = НСтр("ru = 'Шифрование данных'; en = 'Data encryption'");
	КонецЕсли;
	
	Таблица.Очистить();
	Строка = Таблица.Добавить();
	Строка.Свойство = НСтр("ru = 'Кому выдан:'; en = 'Issued to:'");
	Строка.Значение = СокрЛП(СтруктураСертификата.КомуВыдан);
	
	Строка = Таблица.Добавить();
	Строка.Свойство = НСтр("ru = 'Кем выдан:'; en = 'Issued by'");
	Строка.Значение = СокрЛП(СтруктураСертификата.КемВыдан);
	
	Строка = Таблица.Добавить();
	Строка.Свойство = НСтр("ru = 'Действителен до:'; en = 'Expiration date:'");
	Строка.Значение = Формат(СтруктураСертификата.ДействителенДо, "ДЛФ=D");
	
	Строка = Таблица.Добавить();
	Строка.Свойство = НСтр("ru = 'Назначение:'; en = 'Purpose:'");
