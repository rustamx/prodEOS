...
Процедура ПриСозданииКонтекстаВзаимодействия(Контекст) Экспорт
	...
	Контекст.Вставить("СообщениеОНедоступностиДействия",
		НСтр("ru = 'Отображение монитора Интернет-поддержки недоступно для этой конфигурации.'; en = 'Displaying online support monitor is not available for the current configuration.'"));
	...
	Иначе
		...
		Если НастройкаПоказыватьПриОбновлении = Истина
			...
			КонтекстОбработчика.Вставить("ОписаниеПричиныОстановки",
				НСтр("ru = 'Новой информации на сервере Интернет-поддержки пользователей нет.'; en = 'No new information at the online support monitor site.'"));
