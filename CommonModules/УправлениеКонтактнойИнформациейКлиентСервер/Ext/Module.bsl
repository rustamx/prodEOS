...
Функция КодСериализацииПочтовогоИндекса() Экспорт
	...
	Возврат КодСериализацииОбъектаАдресации(НСтр("ru = 'Почтовый индекс'; en = 'Zip code'"));
...
Функция СокращенияОбъектовАдресацииАдресаРФ() Экспорт
	...
	Результат.Вставить(НСтр("ru = 'Дом'; en = 'Building'"), НСтр("ru = 'Д.'; en = 'B.'"));
	Результат.Вставить(НСтр("ru = 'Владение'; en = 'Estate'"), НСтр("ru = 'Вл.'; en = 'Est.'"));
	Результат.Вставить(НСтр("ru = 'Домовладение'; en = 'House and grounds'"), НСтр("ru = 'Домовл.'; en = 'House and grounds'"));
	
	Результат.Вставить(НСтр("ru = 'Корпус'; en = 'Housing'"), НСтр("ru = 'Корп.'; en = 'Housing'"));
	Результат.Вставить(НСтр("ru = 'Строение'; en = 'Building'"), НСтр("ru = 'Стр.'; en = 'Bldg.'"));
	Результат.Вставить(НСтр("ru = 'Литера'; en = 'Letter'"), НСтр("ru = 'Лит.'; en = 'Letter'"));
	Результат.Вставить(НСтр("ru = 'Сооружение'; en = 'Construction'"), НСтр("ru = 'Сооруж.'; en = 'Construction'"));
	Результат.Вставить(НСтр("ru = 'Участок'; en = 'Land site'"), НСтр("ru = 'Уч.'; en = 'Land site'"));
	
	Результат.Вставить(НСтр("ru = 'Квартира'; en = 'Apartment'"), НСтр("ru = 'Кв.'; en = 'Apart.'"));
	Результат.Вставить(НСтр("ru = 'Офис'; en = 'Office'"), НСтр("ru = 'Оф.'; en = 'Of.'"));
	Результат.Вставить(НСтр("ru = 'Бокс'; en = 'Box'"), НСтр("ru = 'Бокс'; en = 'Box'"));
	Результат.Вставить(НСтр("ru = 'Помещение'; en = 'Premises'"), НСтр("ru = 'Пом.'; en = 'Premises'"));
	Результат.Вставить(НСтр("ru = 'Комната'; en = 'Room'"), НСтр("ru = 'Ком.'; en = 'Rm.'"));
...
Функция СтруктураЧастейАдресаНаселенногоПункта(ВариантКлассификатора = "ФИАС") Экспорт
	...
	Результат.Вставить("Регион",           ЭлементАдреснойСтруктуры(НСтр("ru = 'Регион'; en = 'State'"),      НСтр("ru = 'Регион адреса'; en = 'Address state'"),           "СубъектРФ",     1));
	Если ВариантКлассификатора = "ФИАС" Тогда
		Результат.Вставить("Округ",        ЭлементАдреснойСтруктуры(НСтр("ru = 'Округ'; en = 'District'"),       НСтр("ru = 'Округ адреса'; en = 'Address district'"),            "Округ",         2));
	КонецЕсли;
	Результат.Вставить("Район",            ЭлементАдреснойСтруктуры(НСтр("ru = 'Район'; en = 'County'"),       НСтр("ru = 'Район адреса'; en = 'Address county'"),            "СвРайМО/Район", 3));
	Результат.Вставить("Город",            ЭлементАдреснойСтруктуры(НСтр("ru = 'Город'; en = 'City'"),       НСтр("ru = 'Город адреса'; en = 'Address city'"),            "Город",         4));
	Если ВариантКлассификатора = "ФИАС" Тогда
		Результат.Вставить("ВнутригРайон", ЭлементАдреснойСтруктуры(НСтр("ru = 'Внутр. р-н.'; en = 'Hinterland'"), НСтр("ru = 'Внутригородской район'; en = 'Urban district'"),   "ВнутригРайон",  5));
	КонецЕсли;
	Результат.Вставить("НаселенныйПункт", ЭлементАдреснойСтруктуры(НСтр("ru = 'Нас.пункт'; en = 'Settlement'"),
		НСтр("ru = 'Населенный пункт адреса'; en = 'Address locality'"), "НаселПункт",  6, Истина));
		
	Если ВариантКлассификатора <> "БезКлассификатора" Тогда
		Результат.Вставить("Улица", ЭлементАдреснойСтруктуры(НСтр("ru = 'Улица'; en = 'Street'"),
			НСтр("ru = 'Улица адреса'; en = 'Address street'"), "Улица", 7));
		Результат.Вставить("ДополнительныйЭлемент", ЭлементАдреснойСтруктуры(НСтр("ru = 'ДополнительныйЭлемент'; en = 'AdditionalItem'"),
			НСтр("ru = 'Дополнительный элемент адреса'; en = 'Address additional item'"), "ДопАдрЭл[ТипАдрЭл='10200000']", 90));
		Результат.Вставить("ПодчиненныйЭлемент", ЭлементАдреснойСтруктуры(НСтр("ru = 'Подчиненный элемент'; en = 'Child item'"),
			НСтр("ru = 'Подчиненный элемент адреса'; en = 'Child address item'"), "ДопАдрЭл[ТипАдрЭл='10400000']", 91));
	КонецЕсли;
