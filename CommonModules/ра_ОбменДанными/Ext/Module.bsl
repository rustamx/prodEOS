...
Функция ПолучитьЗапрос(ТаблицаРеквизитов, ПараметрыЗапросаHTTP, ТекстЗапросаИЗ, ТекстЗапросаВложенныеТаблицы, ТекстЗапросаСоединений, УсловиеПометкиУдаления = Ложь) Экспорт
