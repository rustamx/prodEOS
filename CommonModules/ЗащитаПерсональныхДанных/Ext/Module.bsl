...
Процедура ДобавитьКомандуПечатиСогласияНаОбработкуПерсональныхДанных(КомандыПечати) Экспорт
	...
	КомандаПечати.Представление = НСтр("ru = 'Согласие на обработку ПДн...'; en = 'Consent on PD processing...'");
...
Процедура ПриЗаполненииСпискаТекущихДел(ТекущиеДела) Экспорт
	...
	Для Каждого Раздел Из Разделы Цикл
		...
		Дело.Представление  = НСтр("ru = 'Согласия на обработку ПДн'; en = 'Consents on PD processing'");
		Дело.Количество     = ИстекшиеСогласия.Количество();
		Дело.Подсказка      = НСтр("ru = 'Истекли согласия на обработку персональных данных (ПДн). Необходимо прекратить обработку ПДн или запросить у субъекта продление согласия на обработку.'; en = 'Consents to the processing of personal data expired. It is necessary to stop processing personal data or request the renewal of consent from the subject.'");
...
Функция ОбластиПерсональныхДанных()
	...
	НоваяОбласть.Представление = НСтр("ru = 'Обработка ПДн'; en = 'PD processing'");
...
Функция ДеревоОбластейПерсональныхДанных()
	...
	Если ОбластиДанных.Количество() = 0 
		...
		ДобавитьОбластьДанныхВДерево(ДеревоОбластейДанных, ОбластиДанных, Новый Структура("Имя, Представление, Родитель", "", НСтр("ru = 'Персональные данные'; en = 'Personal data'")));
	КонецЕсли;
