...
Функция СообщенияОбОшибках() Экспорт
	...
	СообщенияОбОшибках.Вставить(8,  НСтр("ru = 'Не корректно указано имя файла для выгрузки данных'; en = 'Invalid data export file name'"));
	...
	СообщенияОбОшибках.Вставить(45, НСтр("ru = 'Не найдено правило конвертации объектов'; en = 'No object conversion rule is found'"));
	...
	СообщенияОбОшибках.Вставить(71, НСтр("ru = 'Не найдено соответствие для значения Источника'; en = 'Mapping value for the source value is not found'"));
	...
	СообщенияОбОшибках.Вставить(74, НСтр("ru = 'Необходимо перезагрузить правила обмена для выгрузки данных.'; en = 'Data exchange rules for export must be loaded again.'"));
	...
	СообщенияОбОшибках.Вставить(81, НСтр("ru = 'Возникла коллизия изменений объектов.
		...
		|en = 'There were conflicting object changes.
		|Object of this infobase was replaced with the version from the second infobase.'"));
	//
	СообщенияОбОшибках.Вставить(82, НСтр("ru = 'Возникла коллизия изменений объектов.
		...
		|en = 'There were conflicting object changes.
		|Object from the second infobase was not received. Object of this infobase was not changed.'"));
	//
	...
	СообщенияОбОшибках.Вставить(177, НСтр("ru = 'Имя плана обмена из сообщения обмена не соответствует ожидаемому.'; en = 'Exchange plan name from the exchange message is not the expected one.'"));
	СообщенияОбОшибках.Вставить(178, НСтр("ru = 'Получатель из сообщения обмена не соответствует ожидаемому.'; en = 'Recipient of the message does not match the expected one.'"));
...
Функция ПланОбменаАвтономнойРаботы() Экспорт
	...
	Если Результат.Количество() = 0 Тогда
		...
		ВызватьИсключение НСтр("ru = 'Автономная работа в системе не предусмотрена.'; en = 'Offline work in the system is not supported.'");
		
	ИначеЕсли Результат.Количество() > 1 Тогда
		
		ВызватьИсключение НСтр("ru = 'Создано более одного плана обмена для автономной работы.'; en = 'More than one exchange plan for offline work were created.'");
	...
	Иначе
		...
		Если Не Каталог.Существует() Тогда
			...
			ШаблонСообщения = НСтр("ru = 'Каталог временных файлов не существует.
					...
					|Make sure that the correct value of the parameter ""%1"" is specified in the program settings.'");
