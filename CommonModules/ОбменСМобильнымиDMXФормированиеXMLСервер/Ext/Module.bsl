...
Процедура ВыгрузитьПользователейПоВерсии206(ЗаписьXML, ЭлементДанных, ПараметрыСинхронизации)
	...
	Если ЗначениеЗаполнено(ЭлементДанных.ра_Организация) Тогда  
		...
		Запрос.УстановитьПараметр("Ссылка", ЭлементДанных.ра_Организация);
		...
		ЗаписатьЭлементОбъектаДанных(ЗаписьXMLОбъекта, "Name",Строка(Выборка.Наименование));
