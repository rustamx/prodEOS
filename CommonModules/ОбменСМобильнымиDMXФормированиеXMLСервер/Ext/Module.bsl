...
Процедура ВыгрузитьВXMLra_Signal(ЗаписьXML, ВерсияКлиента, ПараметрыСинхронизации, ЭлементДанных)
	...
	Реквизиты = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ЭлементДанных, "Ссылка,Проведен,Дата,Description,MestoViyavleniya,VyyavivsheeLico");
	...
	ЗаписатьЭлементОбъектаДанных(ЗаписьXMLОбъекта, "Description", Реквизиты.Description);
