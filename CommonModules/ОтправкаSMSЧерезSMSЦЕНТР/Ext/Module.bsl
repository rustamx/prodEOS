...
Функция ОписаниеОшибкиОтправки(КодОшибки)
	...
	ОписанияОшибок.Вставить(1, НСтр("ru = 'Ошибка в параметрах.'; en = 'Error in the parameters.'"));
	ОписанияОшибок.Вставить(2, НСтр("ru = 'Неверный логин или пароль.'; en = 'Invalid login or password.'"));
	ОписанияОшибок.Вставить(3, НСтр("ru = 'Недостаточно средств на счете.'; en = 'Not enough funds on the account.'"));
	ОписанияОшибок.Вставить(4, НСтр("ru = 'IP-адрес временно заблокирован из-за частых ошибок в запросах.Подробнее см. http://smsc.ru/faq/99'; en = 'The IP address is temporarily blocked because of frequent errors in queries, see for details. http://smsc.ru/faq/99'"));
	ОписанияОшибок.Вставить(5, НСтр("ru = 'Неверный формат даты.'; en = 'Invalid date format.'"));
	ОписанияОшибок.Вставить(6, НСтр("ru = 'Сообщение запрещено (по тексту или по имени отправителя).'; en = 'The message is prohibited (by text or by name of the sender).'"));
	ОписанияОшибок.Вставить(7, НСтр("ru = 'Неверный формат номера телефона.'; en = 'Invalid phone number format.'"));
	ОписанияОшибок.Вставить(8, НСтр("ru = 'Сообщение на указанный номер не может быть доставлено.'; en = 'Message to this number can not be delivered.'"));
	ОписанияОшибок.Вставить(9, НСтр("ru = 'Отправка более одного одинакового запроса на передачу SMS-сообщения в течение минуты.'; en = 'Sending more than one of the same request for transfer of SMS-messages within minutes.'"));
...
Функция ОписаниеОшибкиПолученияСтатуса(КодОшибки)
	...
	ОписанияОшибок.Вставить(1, НСтр("ru = 'Ошибка в параметрах.'; en = 'Error in the parameters.'"));
	ОписанияОшибок.Вставить(2, НСтр("ru = 'Неверный логин или пароль.'; en = 'Invalid login or password.'"));
	ОписанияОшибок.Вставить(5, НСтр("ru = 'Ошибка удаления сообщения.'; en = 'Error deleting messages.'"));
	ОписанияОшибок.Вставить(4, НСтр("ru = 'IP-адрес временно заблокирован из-за частых ошибок в запросах. Подробнее см. http://smsc.ru/faq/99'; en = 'The IP address is temporarily blocked because of frequent errors in queries. For details, see. http://smsc.ru/faq/99'"));
	ОписанияОшибок.Вставить(9, НСтр("ru = 'Отправка более пяти запросов на получения статуса одного и того же сообщения в течение минуты.'; en = 'Sending more than five requests to obtain the same status message within minutes.'"));
...
Функция Разрешения() Экспорт
	...
	Адрес = "smsc.ru";
	Порт = Неопределено;
	Описание = НСтр("ru = 'Отправка SMS через ""SMS-ЦЕНТР"".'; en = 'Sending SMS through ""SMS-CENTER"".'");
