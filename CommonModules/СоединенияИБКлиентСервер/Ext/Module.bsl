...
Функция ТекстДляАдминистратора() Экспорт
	...
	Возврат НСтр("ru = 'Для администратора:'; en = 'For administrator:'");
...
Функция СобытиеЖурналаРегистрации() Экспорт
	...
	Возврат НСтр("ru = 'Завершение работы пользователей'; en = 'User sessions termination'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
