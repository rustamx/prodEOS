...
Функция ПолучитьСтандартныеРасписанияДляНапоминания() Экспорт
	...
	Результат.Вставить(НСтр("ru = 'по понедельникам, в 9:00'; en = 'on Monday at 9:00'"), Расписание);
	...
	Расписание.ДниНедели = ДниНедели;
	Результат.Вставить(НСтр("ru = 'по пятницам, в 15:00'; en = 'on Friday at 15:00'"), Расписание);
	...
	Расписание.ПериодНедель = 1;
	Расписание.ВремяНачала = '00010101090000';
	Результат.Вставить(НСтр("ru = 'каждый день, в 9:00'; en = 'every day at 9:00'"), Расписание);
