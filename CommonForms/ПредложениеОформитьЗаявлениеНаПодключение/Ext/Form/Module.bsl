...
Процедура УстановитьВидимостьЭлементов()
	...
	Элементы.ДекорацияПроверка.Заголовок = НСтр("ru = 'Из этой программы можно обмениваться электронными документами с контрагентами.'; en = 'This program is capable of interchange of electronic documents with counterparties.'");
	
	Если КонтрагентВ1СЭДО Тогда
		ШаблонТекстаДекорации = НСтр("ru = 'С контрагентом ""%1"" можно обмениваться электронными документами
		|из этой программы.'; en = 'Counterparty ""%1"" supports electronic documents interchange.'");
