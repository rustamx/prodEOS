...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтатусОтправки = НСтр("ru = 'Сообщение отправляется...'; en = 'The message is being sent...'");
	...
	Заголовок = НСтр("ru = 'Отправка SMS на телефон'; en = 'Sending SMS to phone'") + " " + НомераПолучателей;
КонецПроцедуры
...
Процедура Отправить(Команда)
	...
	Если СтрДлина(ТекстСообщения) = 0 Тогда
		ПоказатьПредупреждение(, НСтр("ru = 'Необходимо ввести текст сообщения'; en = 'You must enter message text'"));
		Возврат;
	КонецЕсли;
...
Процедура ПроверитьСтатусДоставки()
	...
	ШаблонСостояния = НСтр("ru = 'Отправка сообщения выполнена. Состояние доставки:
		|%1.';
		|en = 'Message has been sent. Delivery status:
		|%1.'");
...
Функция СтатусДоставки(ИдентификаторСообщения)
	...
	СтатусыДоставки.Вставить("Ошибка", НСтр("ru = 'произошла ошибка при подключении к провайдеру SMS'; en = 'an error occurred while connecting to the SMS provider'"));
	СтатусыДоставки.Вставить("НеОтправлялось", НСтр("ru = 'сообщение не отправлялось провайдером'; en = 'the message is not sent by the provider'"));
	СтатусыДоставки.Вставить("Отправляется", НСтр("ru = 'выполняется отправка провайдером'; en = 'being sent by provider'"));
	СтатусыДоставки.Вставить("Отправлено", НСтр("ru = 'отправлено провайдером'; en = 'sent by the provider'"));
	СтатусыДоставки.Вставить("НеОтправлено", НСтр("ru = 'сообщение не отправлено провайдером'; en = 'the message has not been sent by the provider'"));
	СтатусыДоставки.Вставить("Доставлено", НСтр("ru = 'сообщение доставлено'; en = 'message delivered'"));
	СтатусыДоставки.Вставить("НеДоставлено", НСтр("ru = 'сообщение не доставлено'; en = 'message could not be delivered'"));
