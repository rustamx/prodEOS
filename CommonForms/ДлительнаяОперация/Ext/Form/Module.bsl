...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ТекстСообщения = НСтр("ru = 'Пожалуйста, подождите...'; en = 'Please wait...'");
...
Процедура Подключаемый_ПроверитьВыполнениеЗадания()
	...
	ИначеЕсли Статус = "Ошибка" Тогда
		...
		Если ВозвращатьРезультатВОбработкуВыбора() Тогда
			...
			ПараметрыПредупреждения.Вставить("Заголовок", НСтр("ru = 'Не удалось выполнить запрошенное действие'; en = 'Cannot complete the requested action.'"));
