...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если РежимПодбора Тогда
		Заголовок = НСтр("ru = 'Подбор узлов планов обмена'; en = 'Filling exchange plan nodes'");
	КонецЕсли;
...
Процедура Выбрать(Команда)
	...
	Иначе
		...
		Если ТекущиеДанные = Неопределено Тогда
			ПоказатьПредупреждение(, НСтр("ru = 'Узел не выбран.'; en = 'Node is not selected'"));
		Иначе
...
Процедура ДобавитьИспользуемыйПланОбмена(ОбъектМетаданных)
	...
	Если Параметры.ВыбиратьВсеУзлы Тогда
		...
		НоваяСтрока.УзелПредставление       = НСтр("ru = '<Все информационные базы>'; en = '<All infobases>'");
	КонецЕсли;
