		...
		Если АдресСертификата = Неопределено Тогда
			ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Не удалось открыть сертификат ""%1"",
				           ...
				           |en = 'Unable to open certificate ""%1""
				           |because it is not found in the catalog.'"), Параметры.Ссылка);
		КонецЕсли;
	Иначе // Отпечаток
		...
		Если АдресСертификата = Неопределено Тогда
			ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Не удалось открыть сертификат, т.к. он не найден
				           |по отпечатку ""%1"".';
				           |en = 'The certificate could not be opened because it was not
				           |found by thumbprint ""%1"".'"), Параметры.Отпечаток);
		КонецЕсли;
	КонецЕсли;
...
Процедура ПроверитьЗавершение(Результат, Неопределен) Экспорт
	...
	Если Результат = Истина Тогда
		ПоказатьПредупреждение(, НСтр("ru = 'Сертификат действителен.'; en = 'Certificate is valid.'"));
		
	ИначеЕсли Результат <> Неопределено Тогда
		ПоказатьПредупреждение(, НСтр("ru = 'Сертификат недействителен по причине:'; en = 'Certificate is invalid because:'")
...
Процедура ЗаполнитьСвойстваСубъекта(Сертификат)
	...
	ПредставленияСвойств.Добавить("ОбщееИмя",         НСтр("ru = 'Общее имя'; en = 'Common name'"));
	ПредставленияСвойств.Добавить("Страна",           НСтр("ru = 'Страна'; en = 'Country'"));
	ПредставленияСвойств.Добавить("Регион",           НСтр("ru = 'Регион'; en = 'Region'"));
	ПредставленияСвойств.Добавить("НаселенныйПункт",  НСтр("ru = 'Населенный пункт'; en = 'Settlement'"));
	ПредставленияСвойств.Добавить("Улица",            НСтр("ru = 'Улица'; en = 'Street'"));
	ПредставленияСвойств.Добавить("Организация",      НСтр("ru = 'Организация'; en = 'Company'"));
	ПредставленияСвойств.Добавить("Подразделение",    НСтр("ru = 'Подразделение'; en = 'Department'"));
	ПредставленияСвойств.Добавить("Должность",        НСтр("ru = 'Должность'; en = 'Title'"));
	ПредставленияСвойств.Добавить("ЭлектроннаяПочта", НСтр("ru = 'Электронная почта'; en = 'Email'"));
	ПредставленияСвойств.Добавить("ОГРН",             НСтр("ru = 'ОГРН'; en = 'PSRN'"));
	ПредставленияСвойств.Добавить("ОГРНИП",           НСтр("ru = 'ОГРНИП'; en = 'PSRNIE'"));
	ПредставленияСвойств.Добавить("СНИЛС",            НСтр("ru = 'СНИЛС'; en = 'Retirement insurance number'"));
	ПредставленияСвойств.Добавить("ИНН",              НСтр("ru = 'ИНН'; en = 'TIN'"));
	ПредставленияСвойств.Добавить("Фамилия",          НСтр("ru = 'Фамилия'; en = 'Last name'"));
	ПредставленияСвойств.Добавить("Имя",              НСтр("ru = 'Имя'; en = 'Name'"));
	ПредставленияСвойств.Добавить("Отчество",         НСтр("ru = 'Отчество'; en = 'Middle name'"));
...
Процедура ЗаполнитьВнутренниеПоляСертификата()
	...
	Если ГруппаВнутреннихПолей = "Общие" Тогда
		...
		ДобавитьСвойство(Сертификат, "Версия",                    НСтр("ru = 'Версия'; en = 'Version'"));
		ДобавитьСвойство(Сертификат, "ДатаНачала",                НСтр("ru = 'Дата начала'; en = 'Start date'"));
		ДобавитьСвойство(Сертификат, "ДатаОкончания",             НСтр("ru = 'Дата окончания'; en = 'End date'"));
		ДобавитьСвойство(Сертификат, "ИспользоватьДляПодписи",    НСтр("ru = 'Использовать для подписи'; en = 'Use for signing'"));
		ДобавитьСвойство(Сертификат, "ИспользоватьДляШифрования", НСтр("ru = 'Использовать для шифрования'; en = 'Use for encryption'"));
		ДобавитьСвойство(Сертификат, "ОткрытыйКлюч",              НСтр("ru = 'Открытый ключ'; en = 'Public key'"), Истина);
		ДобавитьСвойство(Сертификат, "Отпечаток",                 НСтр("ru = 'Отпечаток'; en = 'Thumbprint'"), Истина);
		ДобавитьСвойство(Сертификат, "СерийныйНомер",             НСтр("ru = 'Серийный номер'; en = 'Serial number'"), Истина);
