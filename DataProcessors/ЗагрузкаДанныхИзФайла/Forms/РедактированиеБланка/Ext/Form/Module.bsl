...
Процедура СброситьНастройки(Команда)
	...
	ПоказатьВопрос(Оповещение, НСтр("ru = 'Установить настройки колонок в первоначальное состояние?'; en = 'Set the columns settings to their original state?'"), РежимДиалогаВопрос.ДаНет);
КонецПроцедуры
...
Процедура УстановитьОформлениеДанных()
	...
	ЭлементОтбора.Использование = Истина;
	ЭлементУсловногоОформления.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = 'Стандартное наименование'; en = 'Standard name'"));
