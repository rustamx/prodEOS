...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Элементы.ДополнительныеТерритории.Видимость = Ложь И Элементы.УлицыИНаселенныеПункты.Видимость = Ложь Тогда
		КраткоеПредставлениеОшибки = НСтр("ru = 'Данные о улицах, населенных пунктах и дополнительных территориях для введенного адреса отсутствуют'; en = 'Data on streets, settlements and additional territories for the address you entered is missing'");
		Возврат;
	КонецЕсли;
