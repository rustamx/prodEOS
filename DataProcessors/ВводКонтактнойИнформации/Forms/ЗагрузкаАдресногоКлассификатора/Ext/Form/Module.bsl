...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИначеЕсли Параметры.НазваниеРегиона Тогда
		ТекстВопроса = НСтр("ru = 'Для автоподбора и выбора адресных сведений необходимо загрузить классификатор по региону ""%1"".'; en = 'For autocompletion and for address validation you must import the classifier for region ""%1"".'");
