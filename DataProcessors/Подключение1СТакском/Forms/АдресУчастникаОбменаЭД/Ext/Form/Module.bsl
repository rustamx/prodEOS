...
Процедура ПередЗакрытием(Отказ, ЗавершениеРаботы, ТекстПредупреждения, СтандартнаяОбработка)
	...
	Если Модифицированность И Не ПрограммноеЗакрытие Тогда
		...
		ТекстВопроса = НСтр("ru = 'Адрес участника обмена электронными документами изменен.
			|Сохранить изменения?';
			|en = 'Address of EDI participant was changed.
			|Save changes?'");
...
Процедура КодРегионаНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Если СписокКодовРегионов = Неопределено Тогда
		...
		ТекстПредупреждения = НСтр("ru = 'Список кодов еще не загружен. Нажмите на ссылку ""Загрузить"" или введите код региона вручную.'; en = 'Code list is not yet imported. Click the ""Import"" link or enter region code manually.'");
	...
	СписокКодовРегионов.ПоказатьВыборЭлемента(
		ОписаниеОповещения,
		НСтр("ru = 'Коды регионов'; en = 'Region codes'"),
