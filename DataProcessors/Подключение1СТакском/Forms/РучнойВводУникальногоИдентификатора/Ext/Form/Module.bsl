	...
	Если НавигационнаяСсылка = "TechSupport" Тогда
		...
		ТекстСообщения =
			НСтр("ru = 'У меня не получается ввести уникальный идентификатор участника ЭД вручную.
				...
				|
				|%1';
				|en = 'I cannot enter the unique identifier of the EDI participant manually.
				|
				|I request your help to deal with the problem.
				|
				|%1'");
		...
		ИнтернетПоддержкаПользователейКлиент.ОтправитьСообщениеВТехПоддержку(
			НСтр("ru = '1С-Такском. Ввод уникального идентификатора участника обмена ЭД вручную.'; en = '1C-Taxcom. Entering a unique identifier of EDI participant manually.'"),
			ТекстСообщения,
			"taxcom",
			,
