...
Процедура Инициализация() Экспорт
	...
	ТемаСообщения = СтрШаблон(ТемаСообщения, ШаблонИмениФайлаСообщения);
	
	ТелоСообщенияПростое	= НСтр("ru = 'Сообщение обмена данными'; en = 'Data exchange message'");
	ТелоСообщенияСжатое	= НСтр("ru = 'Сжатое сообщение обмена данными'; en = 'Compressed data exchange message'");
	ТелоСообщенияПакетное	= НСтр("ru = 'Пакетное сообщение обмена данными'; en = 'Batch data exchange message'");
...
Функция ОтправитьСообщениеОбмена()
	...
	Если СжиматьФайлИсходящегоСообщения() Тогда
		...
		Попытка
			...
			Архиватор = Новый ЗаписьZipФайла(ИмяВременногоФайлаАрхива, ПарольАрхиваСообщенияОбмена, НСтр("ru = 'Файл сообщения обмена'; en = 'Exchange message file'"));
...
Функция ПолучитьСообщениеОбмена()
	...
	Если ТаблицаСообщенийОбмена.Количество() = 0 Тогда
		...
		СтрокаСообщения = НСтр("ru = 'Не обнаружены письма с заголовком: ""%1""'; en = 'Emails with subject ""%1"" not found'");
		СтрокаСообщения = СтрШаблон(СтрокаСообщения, ТемаСообщения);
...
Процедура УстановитьСтрокуСообщенияОбОшибке(Знач Сообщение)
	...
	Если Сообщение = Неопределено Тогда
		Сообщение = НСтр("ru = 'Внутренняя ошибка'; en = 'Internal error'");
	КонецЕсли;
...
Процедура ИнициализацияСообщенийОшибок()
	...
	// Общие коды ошибок
	СообщенияОшибок.Вставить(001, НСтр("ru = 'Не обнаружены сообщения обмена.'; en = 'Exchange messages not found.'"));
	СообщенияОшибок.Вставить(002, НСтр("ru = 'Ошибка при распаковке сжатого файла сообщения.'; en = 'Error when unpacking the compressed message file.'"));
	СообщенияОшибок.Вставить(003, НСтр("ru = 'Ошибка при сжатии файла сообщения обмена.'; en = 'Error when compressing the exchange message file.'"));
	СообщенияОшибок.Вставить(004, НСтр("ru = 'Ошибка при создании временного каталога'.; en = 'Error creating the temporary directory'"));
	СообщенияОшибок.Вставить(005, НСтр("ru = 'Архив не содержит файл сообщения обмена.'; en = 'Archive does not contain exchange message.'"));
	СообщенияОшибок.Вставить(006, НСтр("ru = 'Сообщение обмена не отправлено: превышен допустимый размер сообщения.'; en = 'Exchange message not sent: size limit exceeded.'"));
	
	// Коды ошибок, зависящие от вида транспорта.
	СообщенияОшибок.Вставить(101, НСтр("ru = 'Ошибка инициализации: не указана учетная запись электронной почты транспорта сообщений обмена.'; en = 'Initialization error: email account for exchange transport is not specified.'"));
	СообщенияОшибок.Вставить(102, НСтр("ru = 'Ошибка при отправке сообщения электронной почты.'; en = 'Error sending email message.'"));
	СообщенияОшибок.Вставить(103, НСтр("ru = 'Ошибка при получении заголовков сообщений с сервера электронной почты.'; en = 'Error retrieving message headers from email server.'"));
	СообщенияОшибок.Вставить(104, НСтр("ru = 'Не обнаружены сообщения обмена на почтовом сервере.'; en = 'Exchange messages not found on the mail server.'"));
	СообщенияОшибок.Вставить(105, НСтр("ru = 'Ошибка при получении сообщения с сервера электронной почты.'; en = 'Error retrieving messages from the mail server.'"));
	СообщенияОшибок.Вставить(106, НСтр("ru = 'Ошибка при записи файла сообщения обмена на диск.'; en = 'Error saving exchange message file to disk'"));
	СообщенияОшибок.Вставить(107, НСтр("ru = 'Проверка параметров учетной записи завершилась с ошибками.'; en = 'Account settings test failed.'"));
	СообщенияОшибок.Вставить(108, НСтр("ru = 'Превышен допустимый размер сообщения обмена.'; en = 'Exchange message size limit exceeded.'"));
	СообщенияОшибок.Вставить(109, НСтр("ru = 'Ошибка: в почтовом сообщении не найден файл с сообщением.'; en = 'Error: message file not found in the email message.'"));
...
ИмяОбъекта = НСтр("ru = 'Обработка: %1'; en = 'Data processor: %1'");
ИмяОбъекта = СтрШаблон(ИмяОбъекта, Метаданные().Имя);
