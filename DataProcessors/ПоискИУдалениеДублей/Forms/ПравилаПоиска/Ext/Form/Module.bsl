...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru = 'Правила поиска дублей ""%1""'; en = 'Duplicates search rules ""%1""'"), Параметры.ПредставлениеОбластиОтбора);
...
Процедура УчитыватьПрикладныеПравилаПриИзменении(Элемент)
	...
	ТекстЗаголовка = НСтр("ru = 'Предупреждение'; en = 'Warning'");
	ТекстВопроса   = НСтр("ru = 'Внимание: поиск и удаление дублей элементов без учета поставляемых ограничений
	                            ...
	                            |en = 'Note: search and delete duplicates excluding supplied restrictions can lead to misalignment of data.
	                            |
	                            |Disable supplied restrictions?'");
...
Функция ОшибкиВыбора()
	...
	Возврат НСтр("ru ='Необходимо указать хотя бы одно правило поиска дублей.'; en = 'Specify at least one duplicates search rule.'");
КонецФункции
