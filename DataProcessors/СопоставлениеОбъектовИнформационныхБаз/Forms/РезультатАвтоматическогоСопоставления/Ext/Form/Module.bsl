...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не Параметры.Свойство("ИмяФайлаСообщенияОбмена") Тогда
		...
		НСтрока = НСтр("ru = 'Форма не может быть открыта интерактивно.'; en = 'The form cannot be opened interactively.'");
...
Процедура ПередЗакрытием(Отказ, ЗавершениеРаботы, ТекстПредупреждения, СтандартнаяОбработка)
	...
	Если ЗавершениеРаботы Тогда
		Возврат;
	КонецЕсли;
	ПоказатьПредупреждение(, НСтр("ru = 'Форма содержит данные автоматического сопоставления. Действие отменено.'; en = 'The form contains data for automatic mapping. Action canceled.'"));
...
Функция ФоновоеЗаданиеЗапуститьНаСервере(Отказ)
	...
	ПараметрыВыполнения.НаименованиеФоновогоЗадания = НСтр("ru = 'Автоматическое сопоставление объектов'; en = 'Automatic object mapping'");
...
Процедура ЗафиксироватьОшибку(ПодробноеПредставлениеОшибки)
	ЗаписьЖурналаРегистрации(
		НСтр("ru = 'Помощник сопоставления объектов.Автоматическое сопоставление'; en = 'Object mapping assistant.Automatic mapping'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
