...
Функция РезультатСопоставленияОбъектов(Параметры)
	...
	Если Параметры.РеквизитыФормы.ТолькоПрименитьТаблицуНеутвержденныхЗаписей Тогда
		...
		Если Отказ Тогда
			ВызватьИсключение НСтр("ru = 'Возникли ошибки в процессе сопоставления объектов.'; en = 'There were errors during object mapping.'");
		КонецЕсли;
...
Функция РезультатАвтоматическогоСопоставленияОбъектов(Параметры)
	...
	Если Отказ Тогда
		ВызватьИсключение НСтр("ru = 'Возникли ошибки в процессе автоматического сопоставления объектов.'; en = 'There were errors during automatic object mapping.'");
	КонецЕсли;
