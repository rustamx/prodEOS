...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ТолькоОбновлениеПараметровРаботыПрограммы Тогда
		Заголовок = НСтр("ru = 'Обновление параметров работы программы'; en = 'Update of the program operation parameters'");
	...
	ИначеЕсли РежимОбновленияДанных = "НачальноеЗаполнение" Тогда
		Заголовок = НСтр("ru = 'Начальное заполнение данных'; en = 'Initial data filling'");
	...
	ИначеЕсли РежимОбновленияДанных = "ПереходСДругойПрограммы" Тогда
		Заголовок = НСтр("ru = 'Переход с другой программы'; en = 'Transition from the other program'");
	...
	Иначе
		Заголовок = НСтр("ru = 'Обновление версии программы'; en = 'Application version update'");
...
Функция ЗагрузитьОбновитьПараметрыРаботыПрограммыВФоне()
	...
	ПараметрыОперации.НаименованиеФоновогоЗадания = НСтр("ru = 'Фоновое обновление параметров работы программы'; en = 'Background update of application parameters'");
...
Процедура ЗавершитьОбновлениеПараметровРаботыПрограммы(Результат, ДополнительныеПараметры) Экспорт
	...
	Если Результат = Неопределено Или Результат.Статус = "Отменено" Тогда
		...
		КраткоеСообщениеОбОшибке = НСтр("ru = 'Ошибка получения результата от фонового задания при обновлении параметров работы программы.'; en = 'Error getting background job result when updating application parameters.'");
...
Функция ЗапускЗадания()
	...
	ПараметрыВыполнения.НаименованиеФоновогоЗадания = НСтр("ru = 'Фоновая регистрация данных отложенного обновления'; en = 'Background data queued updating registration'");
