...
Процедура СкрытьКонфиденциальнуюИнформацию(Объект, Реквизиты = "", Отбор = "", ОтборПоИ = Ложь) Экспорт
	...
	ТекстОтборНеЗадан = НСтр("ru = 'Отбор на задан!'; en = 'Filter is not specified!'");
...
Процедура ДобавитьОбъекты(ОбъектМетаданных, СтрокаДерева, ТипМетаданных)
	...
	Если ТипМетаданных.Ключ = "Константы" Тогда
		...
		СтрокаОбъект.ПредставлениеПравилаОбработки = НСтр("ru = 'По умолчанию'; en = 'Default'");
...
Процедура ДобавитьСвойства(ОбъектМетаданных, СтрокаДерева, Тип, ЕстьОбрабатываемыеСвойства)
	...
	Если Тип = "СтандартныеРеквизиты" Тогда
		Имя = Тип;
		Синоним = НСтр("ru = 'Стандартные реквизиты'; en = 'Standard attributes'");
	...
	Иначе
		...
		Если Тип = "ПризнакиУчета" Тогда
			Синоним = НСтр("ru = 'Признаки учета'; en = 'Signs of accounting'");
		Иначе
			Синоним = Тип;
		КонецЕсли;
		Коллекция = ОбъектМетаданных[Тип];
	...
	Для Каждого ЭлементКоллекции Из Коллекция Цикл
		...
		СтрокаСвойство.ПредставлениеПравилаОбработки = НСтр("ru = 'По умолчанию'; en = 'Default'");
