...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если НЕ Параметры.Свойство("ОткрытаПоСценарию") Тогда
		ВызватьИсключение НСтр("ru='Обработка не предназначена для непосредственного использования.'; en = 'Data processor cannot be opened manually'");
	КонецЕсли;
	...
	ТекстУсловие = ?(Параметры.ЗавершитьРаботу, НСтр("ru = 'необходимо'; en = 'required'"), НСтр("ru = 'рекомендуется'; en = 'recommended'"));
	...
	Если Параметры.ЗавершитьРаботу Тогда
		...
		Заголовок = НСтр("ru = 'Необходимо обновить версию платформы'; en = 'Required to update the platform version'");
	КонецЕсли;
