...
Процедура ДобавитьСправочники(СписокЭлементов, Знач МетаданныеСтр)
	...
	СписокСправочников = НовыйЭлементДерева(СписокЭлементов, НСтр("ru = 'Справочники'; en = 'Catalogs'"), МетаданныеСправочникиСтр, Истина, БиблиотекаКартинок.Справочник).ПолучитьЭлементы();
...
Процедура ДобавитьДокументы(СписокЭлементов, Знач МетаданныеСтр)
	...
	СписокДокументов = НовыйЭлементДерева(СписокЭлементов, НСтр("ru = 'Документы'; en = 'Documents'"), МетаданныеДокументыСтр, Истина, БиблиотекаКартинок.Документ).ПолучитьЭлементы();
...
Процедура ДобавитьБизнесПроцессы(СписокЭлементов, Знач МетаданныеСтр)
	...
	СписокБизнесПроцессов = НовыйЭлементДерева(СписокЭлементов, НСтр("ru = 'Процессы'; en = 'Processes'"), МетаданныеБизнесПроцессыСтр, Истина, БиблиотекаКартинок.БизнесПроцесс).ПолучитьЭлементы();
...
Процедура ДобавитьЗадачи(СписокЭлементов, Знач МетаданныеСтр)
	...
	СписокЗадач = НовыйЭлементДерева(СписокЭлементов, НСтр("ru = 'Задачи'; en = 'Tasks'"), МетаданныеЗадачиСтр, Истина, БиблиотекаКартинок.Задача).ПолучитьЭлементы();
...
Процедура ОК(Команда)
	...
	Если ПолнотекстовыйПоискСерверДокументооборот.ЭтоСтандартныйРазделПоиска(Наименование) Тогда
		ПоказатьПредупреждение(, НСтр("ru = 'Наименование раздела совпадает со стандартным разделом поиска. Переименуйте раздел.'; en = 'The name of the section is the same as default search section. Please, rename section.'"));
		Возврат;
	КонецЕсли;
