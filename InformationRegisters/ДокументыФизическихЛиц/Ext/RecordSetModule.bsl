...
Процедура ПередЗаписью(Отказ, Замещение)
	...
	ТекстСерия				= НСтр("ru = ', серия: %1'; en = ', series: %1'");
	ТекстНомер				= НСтр("ru = ', № %1'; en = ', № %1'");
	ТекстДатаВыдачи			= НСтр("ru = ', выдан: %1 года'; en = ', issued: %1 year'");
	ТекстСрокДействия		= НСтр("ru = ', действует до: %1 года'; en = ', valid to: %1 year'");
	ТекстКодПодразделения	= НСтр("ru = ', № подр. %1'; en = ', № dept. %1'");
...
Процедура ПриЗаписи(Отказ, Замещение)
	...
	ТекстСообщения = НСтр("ru = 'На %1 у физлица %2 уже введен документ, удостоверяющий личность.'; en = 'On %1 individual %2 already has an identity document.'");
