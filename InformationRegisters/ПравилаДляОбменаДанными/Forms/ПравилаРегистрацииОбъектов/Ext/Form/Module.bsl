...
Процедура ЗагрузитьПравила(Команда)
	...
	ПараметрыДиалога.Вставить("Заголовок", НСтр("ru = 'Укажите, из какого файла загрузить правила'; en = 'Specify the file from which the rules should be imported'"));
	ПараметрыДиалога.Вставить("Фильтр",
		  НСтр("ru = 'Файлы правил регистрации (*.xml)'; en = 'Registration rule files (*.xml)'") + "|*.xml|"
		+ НСтр("ru = 'Архивы ZIP (*.zip)'; en = 'ZIP archives (*.zip)'")   + "|*.zip");
...
Процедура ВыгрузитьПравила(Команда)
	...
	ФильтрИмени = НСтр("ru = 'Файлы правил (*.xml)'; en = 'Rule file (*.xml)'") + "|*.xml";
