...
Функция ПолучитьМассивКнопок(МенеджерЗаписи) Экспорт
	...
	Если ВидФормы = "ФормаСписка" Тогда
		...
		КнопкаДобавитьКуратора.Hint = НСтр("ru = 'Пользователь ответственный за распространение итогового отчета'; en = 'User responsible for distributing the final report'"); // ТСК Ткаченко И.Л. 11.12.2018 - Текст всплывающей подсказки
