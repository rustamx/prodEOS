...
Процедура ДополнитьОписаниеМетаданных(ОбработкаОбъект, Данные, ПараметрыФормирования) Экспорт
	...
	ОбработкаОбъект.ДобавитьПоле("", МетаданныеДокумента.Реквизиты.Proekt);
	...
	ОбработкаОбъект.УстановитьСвязиПараметровВыбора(
		"ProektnayaDokumentaciya,
		|RabochayaDokumentaciya,
		|NaimenovanieTekhnologicheskojSistemy,
		|Oborudovanie", СвязиПараметровВыбора);
