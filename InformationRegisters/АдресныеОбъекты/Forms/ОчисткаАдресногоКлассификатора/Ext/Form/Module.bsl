...
Процедура ПередЗакрытием(Отказ, ЗавершениеРаботы, ТекстПредупреждения, СтандартнаяОбработка)
	...
	Текст = НСтр("ru = 'Прервать очистку адресного классификатора?'; en = 'Terminate address classifier clearing?'");
...
Процедура ОбновитьИнтерфейсПоКоличествуОчищаемых()
	...
	// Страница загрузки
	ТекстОписанияОчистки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru = 'Очищаются данные выбранных регионов (%1)'; en = 'Data of selected regions (%1) are being cleared'"), ВыбраноРегионовДляОчистки);
...
Процедура ОчиститьКлассификатор()
	...
	ТекстСостоянияОчистки = НСтр("ru = 'Очистка адресного классификатора ...'; en = 'Clearing address classifier ...'");
...
Процедура ПослеФоновойОчистки(Задание, ДополнительныеПараметры) Экспорт
	Если Задание.Статус = "Выполнено" Тогда
		...
		ТекстОписанияОчистки = НСтр("ru = 'Адресный классификатор успешно очищен.'; en = 'Address classifier cleared successfully.'");
	...
	ИначеЕсли Задание.Статус = "Ошибка" Тогда
		...
		ТекстОшибки = НСтр("ru = 'Не удается очистить адресный классификатор.'; en = 'Unable to clean address classifier.'");
...
Функция ЗапуститьФоновуюОчисткуНаСервере(Знач КодыРегионов, Знач УникальныйИдентификатор)
	...
	ПараметрыВыполнения.НаименованиеФоновогоЗадания = НСтр("ru = 'Очистка адресного классификатора'; en = 'Clear address classifier'");
