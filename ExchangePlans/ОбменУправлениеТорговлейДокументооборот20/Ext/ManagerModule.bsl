...
Функция ИмяФайлаНастроекДляПриемника() Экспорт
	...
	Возврат НСтр("ru = 'Настройки обмена УТ 11 - ДО 2.1'; en = 'Exchange settings TM 11 - DM 2.1'");
...
Функция ЗаголовокКомандыДляСозданияНовогоОбменаДанными() Экспорт
	...
	Возврат НСтр("ru = '1С:Управление торговлей, ред. 11'; en = '1C:Trade management 11'");
...
Функция КраткаяИнформацияПоОбмену(ИдентификаторНастройки) Экспорт
	...
	ПоясняющийТекст = НСтр("ru = 'Позволяет синхронизировать данные между конфигурциями ""1С:Управление торговлей"" и ""1С:Документооборот"".'; en = 'Provides data synchronizaion between ""1C:Document management"" and ""1C:Trade management"".'");
