...
Функция ЗаголовокКомандыДляСозданияНовогоОбменаДанными() Экспорт
	...
	Возврат НСтр("ru = '1С:Управление производственным предприятием, ред. 1.3'; en = '1C:Manufacturing enterprise management 1.3'");
...
Функция КраткаяИнформацияПоОбмену(ИдентификаторНастройки) Экспорт
	...
	|en = 'Provides data synchronizaion between ""1C:Document management"" and ""1C:Manufacturing enterprise management"".
	|Synchronization is two-way and deals with reference information.'");
