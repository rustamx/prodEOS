...
Функция ЗаголовокКомандыДляСозданияНовогоОбменаДанными() Экспорт
	...
	Возврат НСтр("ru = '1С:Документооборот КОРП, ред. 2.0'; en = '1C:Document Management CORP 2.0'");
...
Функция КраткаяИнформацияПоОбмену(ИдентификаторНастройки) Экспорт
	...
	|en = 'Designed to synchronize data between ""1C:Document Management CORP 2.0"" and ""1C:Document Management CORP 2.1"".
	|Synchronization is unidirectional, from 2.0 to 2.1.'");
