...
Функция ДобавитьПредставлениеДанныхВыбора(ПолноеИмяОбъекта, СписокРезультатов)
	...
	Для каждого ЭлементСписка из СписокРезультатов Цикл
		...
		МассивДанных.Добавить(Новый Структура("Ref_Key, Name, Presentation", 
...
Функция ЗаполнитьИЗаписатьОбъект(ОбъектДанных, СтруктураСвойств, ИмяОбъектаМетаданных)
	...
	Если ОбъектДанных.ПроверитьЗаполнение() Тогда
		
		Если ЭтоДокумент Тогда
			
			РежимЗаписи = Неопределено;
			
			Если СтруктураСвойств.Свойство("Parameters") И ТипЗнч(СтруктураСвойств.Parameters) = Тип("Структура") Тогда
				Если СтруктураСвойств.Parameters.Свойство("DocumentWriteMode") Тогда
					Если СтруктураСвойств.Parameters.DocumentWriteMode = "Write" Тогда
						РежимЗаписи = РежимЗаписиДокумента.Запись;
					ИначеЕсли СтруктураСвойств.Parameters.DocumentWriteMode = "Posting" Тогда
