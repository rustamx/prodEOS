...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиОтчета.Описание = НСтр("ru = 'Действующие согласия на обработку персональных данных.'; en = 'Valid consents to the processing of personal data.'");
	
	НастройкиВарианта = МодульВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "ДействующиеСогласия");
	НастройкиВарианта.Описание = НСтр("ru = 'Действующие на выбранную дату согласия на обработку персональных данных.'; en = 'Valid on the selected date consents to the processing of personal data.'");
КонецПроцедуры
