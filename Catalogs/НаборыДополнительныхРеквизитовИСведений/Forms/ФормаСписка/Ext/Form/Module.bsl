...
Процедура ОформитьНаборыИСвойства()
	...
	ЭлементЦветаОформления.Значение = НСтр("ru = 'Наборы'; en = 'Sets'");
...
Процедура НастроитьОтображениеНаборов()
	...
	Если ЭтоНаборыДополнительныхСведений Тогда
		Заголовок = НСтр("ru = 'Дополнительные сведения'; en = 'Additional data'");
		
		КомандаСоздать.Подсказка          = НСтр("ru = 'Создать уникальное сведение'; en = 'Create a unique data'");
		КомандаСоздать.Заголовок          = НСтр("ru = 'Новое'; en = 'New'");
		КомандаСоздать.Подсказка          = НСтр("ru = 'Создать уникальное сведение'; en = 'Create a unique data'");
		
		КомандаСкопировать.Подсказка        = НСтр("ru = 'Создать новое сведение копированием текущего'; en = 'Create new data by copying the current ones'");
		КомандаИзменить.Подсказка           = НСтр("ru = 'Изменить (или открыть) текущее сведение'; en = 'Change (or open) current data'");
		КомандаПометитьНаУдаление.Подсказка = НСтр("ru = 'Пометить текущее сведение на удаление (Del)'; en = 'Mark the current data for deletion (Del)'");
		КомандаПереместитьВверх.Подсказка   = НСтр("ru = 'Переместить текущее сведение вверх'; en = 'Move the current data up'");
		КомандаПереместитьВниз.Подсказка    = НСтр("ru = 'Переместить текущее сведение вниз'; en = 'Move the current data down'");
		...
		Элементы.СвойстваТипЗначения.Подсказка =
			НСтр("ru = 'Типы значения, которое можно ввести при заполнении сведения.'; en = 'Types of values that you enter when filling out additional data.'");
		
		Элементы.СвойстваОбщиеЗначения.Подсказка =
			НСтр("ru = 'Сведение использует список значений сведения-образца.'; en = 'The data uses the data-value sample.'");
		
		Элементы.СвойстваОбщее.Заголовок = НСтр("ru = 'Общее'; en = 'Common'");
		Элементы.СвойстваОбщее.Подсказка = НСтр("ru = 'Общее дополнительное сведение, которое используется в
		                                              |нескольких наборах дополнительных сведений.'; en = 'Common additional data, which is used in several sets of additional data.'");
	Иначе
		Заголовок = НСтр("ru = 'Дополнительные реквизиты'; en = 'Additional attributes'");
		КомандаСоздать.Заголовок          = НСтр("ru = 'Новый'; en = 'New'");
		КомандаСоздать.Подсказка          = НСтр("ru = 'Создать уникальный реквизит'; en = 'Create a unique attribute'");
		
		КомандаСкопировать.Подсказка        = НСтр("ru = 'Создать новый реквизит копированием текущего'; en = 'Create a new attribute by copying the current one'");
		КомандаИзменить.Подсказка           = НСтр("ru = 'Изменить (или открыть) текущий реквизит'; en = 'Edit (or open) current attribute'");
		КомандаПометитьНаУдаление.Подсказка = НСтр("ru = 'Пометить текущий реквизит на удаление (Del)'; en = 'Mark the current attribute for deletion (Del)'");
		КомандаПереместитьВверх.Подсказка   = НСтр("ru = 'Переместить текущий реквизит вверх'; en = 'Move current attribute up'");
		КомандаПереместитьВниз.Подсказка    = НСтр("ru = 'Переместить текущий реквизит вниз'; en = 'Move current attribute down'");
		...
		Элементы.СвойстваТипЗначения.Подсказка =
			НСтр("ru = 'Типы значения, которое можно ввести при заполнении реквизита.'; en = 'Types of values that you enter when filling out the attribute.'");
		
		Элементы.СвойстваОбщиеЗначения.Подсказка =
			НСтр("ru = 'Реквизит использует список значений реквизита-образца.'; en = 'Attribute uses a value list of attribute-sample.'");
		
		Элементы.СвойстваОбщее.Заголовок = НСтр("ru = 'Общий'; en = 'Common'");
		Элементы.СвойстваОбщее.Подсказка = НСтр("ru = 'Общий дополнительный реквизит, который используется в
		                                              |нескольких наборах дополнительных реквизитов.'; en = 'Common additional attribute used in several sets of additional attributes.'");
	КонецЕсли;
	...
	Если Элементы.Свойства.ТекущиеДанные <> Неопределено Тогда
		...
		Если ЭтоНаборыДополнительныхСведений Тогда
			Если Элементы.Свойства.ТекущиеДанные.Общее Тогда
				ТекстВопроса = НСтр("ru ='Исключить текущее общее сведения из набора?'; en = 'Do you want to delete the current common additional data from the set?'");
				
			ИначеЕсли Элементы.Свойства.ТекущиеДанные.ПометкаУдаления Тогда
				ТекстВопроса = НСтр("ru ='Снять с текущего сведения пометку на удаление?'; en = 'Do you want to remove the deletion mark from the current data?'");
			Иначе
				ТекстВопроса = НСтр("ru ='Пометить текущее сведение на удаление?'; en = 'Do you want to mark the current data for deletion?'");
			КонецЕсли;
		Иначе
			Если Элементы.Свойства.ТекущиеДанные.Общее Тогда
				ТекстВопроса = НСтр("ru ='Исключить текущий общий реквизит из набора?'; en = 'Do you want to delete the current common attribute from the set?'");
				
			ИначеЕсли Элементы.Свойства.ТекущиеДанные.ПометкаУдаления Тогда
				ТекстВопроса = НСтр("ru ='Снять с текущего реквизита пометку на удаление?'; en = 'Do you want to remove the deletion mark from the current attribute?'");
			Иначе
				ТекстВопроса = НСтр("ru ='Пометить текущий реквизит на удаление?'; en = 'Do you want to mark the current attribute for deletion?'");
			КонецЕсли;
		КонецЕсли;
				...
				Если ЭтоНаборыДополнительныхСведений Тогда
					ВызватьИсключение
						НСтр("ru = 'Действие не выполнено, так как состав дополнительных сведений
						           ...
						           |en = 'The action was not executed because the additional attributes content
						           |was modified by another user.
						           |New content of additional attributes has been read.
