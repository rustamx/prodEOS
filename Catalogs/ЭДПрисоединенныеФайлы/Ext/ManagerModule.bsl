...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Если ПечататьКарточкуЭД Тогда
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(
			...
			"КарточкаЭД",
			НСтр("ru = 'Карточка электронного документа'; en = 'Electronic document form'"),
	...
	Если ПечататьЭД Тогда
		...
		СинонимМакета = НСтр("ru = 'Электронный документ'; en = 'Electronic document'");
...
Процедура ЗаполнитьНаименованиеФайла() Экспорт
	...
	Пока ЭлементСсылка.Следующий() Цикл
		...
		Исключение
			Операция = НСтр("ru = 'Запись присоединенного файла'; en = 'Saving attached file'");
...
Процедура СообщитьОбОшибке(Знач Описание)
	...
	ЗаписьЖурналаРегистрации(
		НСтр("ru = 'Сертификаты электронной подписи.Перенос настроек в новый объект метаданных'; en = 'Electronic signature certificates. transferring the settings in the new metadata object'",
...
Процедура ЗаполнитьПредставлениеПодписантов(СтрокаМассива, ТребуемыеПодписи)
	...
	Если СтрокаМассива.ПроизвольныйЭД Тогда
		...
		Иначе
			...
			Если СтрокаМассива.НаправлениеЭД = Перечисления.НаправленияЭД.Исходящий Тогда
				...
				ТребуемыеПодписи.ПредставлениеОтправителя = ПредставлениеЮрФизЛицо(СтрокаМассива.ПодписьОрганизации);
				ТребуемыеПодписи.ПредставлениеПолучателя = НСтр("ru = 'Не требуется'; en = 'Not required'");
	...
	Иначе
		...
		Иначе
			ТребуемыеПодписи.ПредставлениеОтправителя = НСтр("ru = 'Не требуется'; en = 'Not required'");
			ТребуемыеПодписи.ПредставлениеПолучателя = НСтр("ru = 'Не требуется'; en = 'Not required'");
