...
Процедура ОбработкаПолученияПредставления(Данные, Представление, СтандартнаяОбработка)
	...
	Если ТекущийЯзык() = Метаданные.Языки.Английский
		и ЗначениеЗаполнено(Данные.ра_НаименованиеАнгл) Тогда
		Представление = Данные.ра_НаименованиеАнгл;	
	Иначе
...
Процедура ОбработкаПолученияПолейПредставления(Поля, СтандартнаяОбработка)
	...
	Поля.Добавить("ра_НаименованиеАнгл");
