...
Процедура Заполнить(Команда)
	Если Сервер = "" Тогда
		ПолныйАдрес = НСтр("ru = 'ftp://логин:пароль@сервер:порт/каталог/'; en = 'ftp://login:password@server:port/catalog/'");
	Иначе
		Если Логин = "" Тогда
	...
	ПоказатьВводСтроки(Обработчик, ПолныйАдрес, НСтр("ru = 'Введите полный ftp адрес'; en = 'Enter the full ftp address'"))
КонецПроцедуры
