	...
	Если ПустаяСтрока(СтрокаЗаголовка) Тогда
		...
		Если ЗначениеЗаполнено(Свойство) Тогда
			Если НЕ Параметры.РежимВыбора Тогда
				СтрокаЗаголовка = НСтр("ru = 'Значения свойства %1'; en = 'Properties value %1'");
			ИначеЕсли ВыборГрупп Тогда
				СтрокаЗаголовка = НСтр("ru = 'Выберите группу значений свойства %1'; en = 'Select the value group of the %1 property'");
			Иначе
				СтрокаЗаголовка = НСтр("ru = 'Выберите значение свойства %1'; en = 'Select the value of the %1 property'");
			КонецЕсли;
		...
		ИначеЕсли Параметры.РежимВыбора Тогда
			...
			Если ВыборГрупп Тогда
				СтрокаЗаголовка = НСтр("ru = 'Выберите группу значений свойства'; en = 'Select the property value group'");
			Иначе
				СтрокаЗаголовка = НСтр("ru = 'Выберите значение свойства'; en = 'Select the property value'");
			КонецЕсли;
		КонецЕсли;
	КонецЕсли;
