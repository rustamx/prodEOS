...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Заголовок = НСтр("ru = 'Сценарии синхронизации данных для: [УзелИнформационнойБазы]'; en = 'Data synchronization scenarios for: [УзелИнформационнойБазы]'");
...
Процедура ВыполнитьСценарий(Команда)
	...
	Сообщение = НСтр("ru = 'Синхронизируются данные по сценарию ""%1""...'; en = 'Data are being synchronized using script ""%1"".'");
	...
	Если Отказ Тогда
		Сообщение = НСтр("ru = 'Сценарий синхронизации выполнен с ошибками.'; en = 'Synchronization scenario executed with errors.'");
		Картинка = БиблиотекаКартинок.Ошибка32;
	Иначе
		Сообщение = НСтр("ru = 'Сценарий синхронизации успешно выполнен.'; en = 'Synchronization scenario executed successfully.'");
