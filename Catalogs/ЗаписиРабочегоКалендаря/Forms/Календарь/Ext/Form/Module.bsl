...
Процедура УстановитьВариантРаботыФормы()
	...
	Если Параметры.ВариантРаботыФормы = "МойКалендарь" Тогда
		...
		Заголовок = НСтр("ru = 'Мой календарь'; en = 'My calendar'");
	...
	ИначеЕсли Параметры.ВариантРаботыФормы = "ВсеКалендари" Тогда
		...
		Заголовок = НСтр("ru = 'Все календари'; en = 'All calendars'");
	...
	ИначеЕсли Параметры.ВариантРаботыФормы = "КалендарьПользователя" Тогда
		...
		Заголовок = СтрШаблон(НСтр("ru = 'Календарь пользователя %1'; en = 'User calendar %1'"), Параметры.Пользователь);
...
Процедура ВыбратьКалендарьПользователя()
	...
	ПараметрыФормы.Вставить("ЗаголовокФормы", НСтр("ru = 'Выбор пользователей календаря'; en = 'Selecting user calendars'"));
