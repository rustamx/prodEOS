...
Процедура ОткрытьНаборСвойств(Команда)
	...
	Если Объект.Ссылка.Пустая() Тогда
		...
		ТекстВопроса = НСтр("ru = 'Для перехода к набору свойств элемент необходимо записать.'; en = 'To proceed to properties the element must be saved.'") + Символы.ПС + НСтр("ru = 'Записать?'; en = 'Save?'");
