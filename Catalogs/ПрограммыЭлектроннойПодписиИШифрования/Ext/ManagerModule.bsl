...
Функция ПоставляемыеНастройкиПрограмм() Экспорт
	...
	Настройка.Представление       = НСтр("ru = 'ViPNet CSP'; en = 'ViPNet CSP'");
	...
	// КриптоПро CSP
	Настройка = Настройки.Добавить();
	Настройка.Представление       = НСтр("ru = 'КриптоПро CSP'; en = 'CryptoPro CSP'");
	...
	// ЛИССИ CSP
	Настройка = Настройки.Добавить();
	Настройка.Представление       = НСтр("ru = 'ЛИССИ CSP'; en = 'LISSI-CSP'");
	...
	Настройка = Настройки.Добавить();
	Настройка.Представление       = НСтр("ru = 'Сигнал-КОМ CSP (RFC 4357)'; en = 'Signal-COM CSP (RFC 4357)'");
	...
	Настройка = Настройки.Добавить();
	Настройка.Представление       = НСтр("ru = 'Сигнал-КОМ CSP (ITU-T X.509 v.3)'; en = 'Signal-COM CSP (ITU-T x. 509 v. 3)'");
	...
	Настройка = Настройки.Добавить();
	Настройка.Представление       = НСтр("ru = 'Microsoft Enhanced CSP'; en = 'Microsoft Enhanced CSP'");
