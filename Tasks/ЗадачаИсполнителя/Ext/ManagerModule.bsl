...
Процедура ДополнитьПредставлениеДляОтклоненныхЗадач(СтруктураРез, ВыборкаЗадача, ОтклоненныеЗадачи)
	...
	Для Каждого СтрокаТЗ Из ОтклоненныеЗадачи.НайтиСтроки(СтруктураОтбор) Цикл
		...
		Если ВыборкаЗадача.ТочкаМаршрута = БизнесПроцессы.Согласование.ТочкиМаршрута.Ознакомиться Тогда
			...
			текстКомментарий_ = текстКомментарий_ + ?(ВыборкаЗадача.ПодписыватьЭП, "Утверждающий ", "Согласующий ") + СтрокаТЗ.Исполнитель + " отклонил с комментарием: '" + СтрокаТЗ.РезультатВыполнения + "'" + Символы.ПС;
			
		ИначеЕсли ВыборкаЗадача.ТочкаМаршрута = БизнесПроцессы.Утверждение.ТочкиМаршрута.Ознакомиться Тогда
			
			текстКомментарий_ = текстКомментарий_ + "Уверждающий " + СтрокаТЗ.Исполнитель + " отклонил с комментарием: '" + СтрокаТЗ.РезультатВыполнения + "'" + Символы.ПС;
			
		ИначеЕсли ВыборкаЗадача.ТочкаМаршрута = БизнесПроцессы.Исполнение.ТочкиМаршрута.Исполнить Тогда
			
			текстКомментарий_ = текстКомментарий_ + "Проверяющий " + СтрокаТЗ.Исполнитель + " вернул на доработку с комментарием: '" + СтрокаТЗ.РезультатВыполнения + "'" + Символы.ПС;
			
		ИначеЕсли ВыборкаЗадача.ТочкаМаршрута = БизнесПроцессы.Согласование.ТочкиМаршрута.Согласовать Тогда
			
			текстКомментарий_ = текстКомментарий_ + "Проверяющий " + СтрокаТЗ.Исполнитель + " вернул на повторное согласование с комментарием: '" + СтрокаТЗ.РезультатВыполнения + "'" + Символы.ПС;
