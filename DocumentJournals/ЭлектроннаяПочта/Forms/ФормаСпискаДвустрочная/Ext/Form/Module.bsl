...
Процедура ЗаполнитьУсловноеОформлениеСпискаПисем(Список)
	...
	ПредставлениеЭлемента = НСтр("ru = 'Выделять непрочтенные письма цветом фона (стандартная настройка)'; en = 'Emphasize unread emails with background color (default setting)'");
	...
	ПредставлениеЭлемента = НСтр("ru = 'Выделять прочтенные письма цветом фона (стандартная настройка)'; en = 'Emphasize read emails with background color (default setting)'");
	ЭлементУсловногоОформления.Представление = ПредставлениеЭлемента;
