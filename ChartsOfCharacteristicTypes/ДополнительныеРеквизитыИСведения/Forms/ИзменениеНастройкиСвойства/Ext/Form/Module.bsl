...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.ЭтоДополнительноеСведение Тогда
		...
		Заголовок = НСтр("ru = 'Изменить настройку дополнительного сведения'; en = 'Change additional data setting'");
	Иначе
...
Процедура ЗаписатьНачало()
	...
	Состояние(НСтр("ru = 'Выполняется изменение настройки свойства. Пожалуйста, подождите'; en = 'Property settings are being modified. Please wait.'"));
...
Функция ЗаписатьНаСервере()
	...
	НаименованиеЗадания = НСтр("ru = 'Изменение настройки дополнительного свойства'; en = 'Changing additional property setting'");
