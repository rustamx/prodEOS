...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Заголовок = НСтр("ru = '%1 дополнительного реквизита ""%2""'; en = '%1 additional attribute ""%2""'");
	Если НастраиваемоеСвойство = "Доступен" Тогда
		ПредставлениеСвойства = НСтр("ru = 'Доступность'; en = 'Enabled'");
	ИначеЕсли НастраиваемоеСвойство = "ЗаполнятьОбязательно" Тогда
		ПредставлениеСвойства = НСтр("ru = 'Обязательность заполнения'; en = 'Mandatory filling'");
	Иначе
		ПредставлениеСвойства = НСтр("ru = 'Видимость'; en = 'Visibility'");
	КонецЕсли;
