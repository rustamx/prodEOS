...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.ВыборОбщегоСвойства Тогда
		...
		Если ЭтоДополнительноеСведение = Истина Тогда
			АвтоЗаголовок = Ложь;
			Заголовок = НСтр("ru = 'Выбор общего дополнительного сведения'; en = 'Common additional data selection'");
		ИначеЕсли ЭтоДополнительноеСведение = Ложь Тогда
			АвтоЗаголовок = Ложь;
			Заголовок = НСтр("ru = 'Выбор общего дополнительного реквизита'; en = 'Common additional attribute selection'");
		КонецЕсли;
	...
	ИначеЕсли Параметры.ВыборВладельцаДополнительныхЗначений Тогда
		...
		АвтоЗаголовок = Ложь;
		Заголовок = НСтр("ru = 'Выбор образца'; en = 'Sample selection'");
	...
	ОбщегоНазначенияКлиентСервер.УстановитьПараметрДинамическогоСписка(
		...
		НСтр("ru = 'Общие (для нескольких наборов)'; en = 'Common (for several sets)'"),
		Истина);
