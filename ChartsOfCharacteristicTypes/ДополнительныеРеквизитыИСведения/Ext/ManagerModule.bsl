		...
		Если МетаданныеВладельца = Неопределено Тогда
			ВызватьИсключение СтрШаблон(
				НСтр("ru = 'Ошибка при изменении настройки свойства %1.
				           ...
				           |en = 'Error when changing property settings %1. 
				           |Property set %2 is not associated with any owner of property values.'"),
				Свойство,
		...
		ИначеЕсли Свойство = СвойствоОбъект.Ссылка Тогда
			ВызватьИсключение СтрШаблон(
				НСтр("ru = 'Ошибка при изменении настройки свойства %1.
				           ...
				           |en = 'Error when changing property settings %1. 
				           |Type of value does not contain additional values.'"),
				Свойство);
		КонецЕсли;
