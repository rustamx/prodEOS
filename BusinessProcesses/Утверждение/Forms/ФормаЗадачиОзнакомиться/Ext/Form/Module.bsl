...
Процедура ЗаписатьИЗакрытьВыполнить()
	...
	Если Записать() Тогда
		...
		ПоказатьОповещениеПользователя(
			НСтр("ru = 'Задача изменена:'; en = 'Task was changed:'"), 
...
Процедура СформироватьЗаголовкиИПодсказкиЭлементовФормы()
	...
	Если ВидПроцесса = Перечисления.ВидыБизнесПроцессаУтверждение.Подписание Тогда
		Если РезультатУтверждения = Перечисления.РезультатыУтверждения.НеУтверждено Тогда 
			Команды.Ознакомился.Заголовок = НСтр("ru = 'Завершить подписание'; en = 'Finish singing'");
			Команды.Повторить.Заголовок = НСтр("ru = 'Повторить подписание...'; en = 'Repeat signing ...'");
		КонецЕсли;
		
		Элементы.РезультатУтверждения.Заголовок = НСтр("ru = 'Результат подписания'; en = 'Signing result'");
		Элементы.УтверждающееЛицо.Заголовок = НСтр("ru = 'Подписант'; en = 'Signatory'");
		Элементы.ДатаУтверждения.Заголовок = НСтр("ru = 'Дата подписания'; en = 'Signature date'");
		...
		Для Каждого ЭлементСписка Из Элементы.РезультатУтверждения.СписокВыбора Цикл
			Если ЭлементСписка.Значение = Перечисления.РезультатыУтверждения.Утверждено Тогда
				ЭлементСписка.Представление = НСтр("ru = 'Подписано'; en = 'Signed'");
			Иначе
				ЭлементСписка.Представление = НСтр("ru = 'Не подписано'; en = 'Not signed'");
			КонецЕсли;
		КонецЦикла;
		
	Иначе
		Если РезультатУтверждения = Перечисления.РезультатыУтверждения.НеУтверждено Тогда 
			Команды.Ознакомился.Заголовок = НСтр("ru = 'Завершить утверждение'; en = 'Finish confirmation'");
			Команды.Повторить.Заголовок = НСтр("ru = 'Повторить утверждение...'; en = 'Repeat confirmation...'");
		КонецЕсли;
		
		Элементы.РезультатУтверждения.Заголовок = НСтр("ru = 'Результат утверждения'; en = 'Confirmation result'");
		Элементы.УтверждающееЛицо.Заголовок = НСтр("ru = 'Утверждающий'; en = 'Confirming person'");
		Элементы.ДатаУтверждения.Заголовок = НСтр("ru = 'Дата утверждения'; en = 'Confirmation date'");
		
		Для Каждого ЭлементСписка Из Элементы.РезультатУтверждения.СписокВыбора Цикл
			Если ЭлементСписка.Значение = Перечисления.РезультатыУтверждения.Утверждено Тогда
				ЭлементСписка.Представление = НСтр("ru = 'Утверждено'; en = 'Confirmed'");
			Иначе
				ЭлементСписка.Представление = НСтр("ru = 'Не утверждено'; en = 'Not confirmed'");
			КонецЕсли;
		КонецЦикла;
