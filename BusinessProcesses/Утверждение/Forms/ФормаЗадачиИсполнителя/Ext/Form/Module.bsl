...
Процедура СформироватьЗаголовкиИПодсказкиЭлементовФормы()
	...
	Если ВидПроцесса = Перечисления.ВидыБизнесПроцессаУтверждение.Подписание Тогда
		Если ПодписыватьЭП Тогда
			Команды.Утверждено.Заголовок = НСтр("ru = 'Подписать (ЭП)'; en = 'Sign (DS)'");
			Команды.Утверждено.Подсказка = НСтр("ru = 'При нажатии кнопки ""Подписать"" потребуется выбрать сертификат для подписи и ввести пароль'; en = 'Upon pressing ""Sign"" button you will be prompted to select the certificate and enter the password'");
		Иначе
			Команды.Утверждено.Заголовок = НСтр("ru = 'Подписать'; en = 'Sign'");
			Команды.Утверждено.Подсказка = Команды.Утверждено.Заголовок;
		КонецЕсли;
		
		Команды.НеУтверждено.Заголовок = НСтр("ru = 'Отклонить'; en = 'Reject'");
		
	Иначе
		Если ПодписыватьЭП Тогда
			Команды.Утверждено.Заголовок = НСтр("ru = 'Утверждено (ЭП)'; en = 'Confirmed (DS)'");
			Команды.Утверждено.Подсказка = НСтр("ru = 'При нажатии кнопки ""Утверждено"" потребуется выбрать сертификат для подписи и ввести пароль'; en = 'Upon pressing ""Confirmed"" button you will be prompted to select the certificate and enter the password'");
		Иначе
			Команды.Утверждено.Заголовок = НСтр("ru = 'Утверждено'; en = 'Confirmed'");
			Команды.Утверждено.Подсказка = Команды.Утверждено.Заголовок;
		КонецЕсли;
		
		Команды.НеУтверждено.Заголовок = НСтр("ru = 'Не утверждено'; en = 'Not confirmed'");
