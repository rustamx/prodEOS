...
Процедура ОбработкаПолученияФормы(ВидФормы, Параметры, ВыбраннаяФорма, ДополнительнаяИнформация, СтандартнаяОбработка)
	...
	ИначеЕсли ВидФормы = "ФормаВыбора" Тогда
		...
		СтандартнаяОбработка = Ложь;
		Параметры.Вставить("Заголовок", НСтр("ru = 'Обработка внутреннего документа'; en = 'Internal document processing'"));
...
Функция ПроверитьШаблон(СтруктураРеквизитов) Экспорт
	...
	Если Не ЗначениеЗаполнено(СтруктураРеквизитов["ШаблонСогласования"]) 
	   ...
	   И Не ЗначениеЗаполнено(СтруктураРеквизитов["ШаблонПоручения"]) Тогда
		...
		Ошибки.Добавить("", НСтр("ru = 'Не указано ни одного шаблона подчиненных процессов'; en = 'Subordinate process templates are not specified'"));
...
Функция ПолучитьОписаниеПроцесса() Экспорт
	...
	Возврат НСтр("ru = 'Описывает процедуру обработки внутреннего документа по заранее определенным правилам.'; en = 'Describes how to process the internal document following the predetermined rules.'");
