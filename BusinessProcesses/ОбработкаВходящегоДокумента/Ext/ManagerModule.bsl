...
Процедура ОбработкаПолученияФормы(ВидФормы, Параметры, ВыбраннаяФорма, ДополнительнаяИнформация, СтандартнаяОбработка)
	...
	ИначеЕсли ВидФормы = "ФормаВыбора" Тогда
		...
		СтандартнаяОбработка = Ложь;
		Параметры.Вставить("Заголовок", НСтр("ru = 'Обработка входящего документа'; en = 'Incoming document processing'"));
...
Функция ПроверитьШаблон(СтруктураРеквизитов) Экспорт
	...
	Если ЗначениеЗаполнено(СтруктураРеквизитов["ШаблонРассмотрения"])
	   И ЗначениеЗаполнено(СтруктураРеквизитов["ШаблонИсполненияОзнакомления"]) Тогда 
		Ошибки.Добавить("ШаблонИсполненияОзнакомления", НСтр("ru = 'Не требуется указывать шаблон исполнения (ознакомления), так как заполнен шаблон рассмотрения'; en = 'Performance or examination template are not necessary because the review template is specified'"));
	КонецЕсли;
	...
	Если Не ЗначениеЗаполнено(СтруктураРеквизитов["ШаблонРассмотрения"])
	   И Не ЗначениеЗаполнено(СтруктураРеквизитов["ШаблонИсполненияОзнакомления"]) Тогда 
		Ошибки.Добавить("", НСтр("ru = 'Укажите шаблон рассмотрения или шаблон исполнения (ознакомления)'; en = 'Specify the template of review or execution (examination)'"));
	КонецЕсли;	
...
Функция ПолучитьОписаниеПроцесса() Экспорт
	...
	Возврат НСтр("ru = 'Описывает процедуру обработки входящего документа по заранее определенным правилам.'; en = 'Describes how to process the incoming document following the predetermined rules.'");
