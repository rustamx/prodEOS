...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ПодписыватьЭП Тогда
		Команды.Согласовано.Заголовок = НСтр("ru = 'Согласовано (ЭП)'; en = 'Approved (DS)'");
		Команды.Согласовано.Подсказка = НСтр("ru = 'При нажатии кнопки ""Согласовано"" потребуется выбрать сертификат для подписи и ввести пароль'; en = 'Upon pressing ""Approved"" you will be prompted to choose the digital certificate and to enter the password'");
		Команды.СогласованоСЗамечаниями.Заголовок = НСтр("ru = 'Согласовано с замечаниями (ЭП)'; en = 'Approved with reservations (DS)'");
		Команды.СогласованоСЗамечаниями.Подсказка = НСтр("ru = 'При нажатии кнопки ""Согласовано с замечаниями"" потребуется выбрать сертификат для подписи и ввести пароль'; en = 'Upon pressing ""Approved with reservations"" you will be prompted to choose the digital certificate and to enter the password'");
		Команды.НеСогласовано.Заголовок = НСтр("ru = 'Не согласовано (ЭП)'; en = 'Not approved (DS)'");
		Команды.НеСогласовано.Подсказка = НСтр("ru = 'При нажатии кнопки ""Не согласовано"" потребуется выбрать сертификат для подписи и ввести пароль'; en = 'Upon pressing ""Not approved"" you will be prompted to choose the digital certificate and to enter the password'");
	КонецЕсли;
...
&НаКлиенте
Процедура ра_ПоказатьМаршрут(Команда)
	КартаМаршрута = ра_ПоказатьМаршрутНаСервере();
	КартаМаршрута.Показать();
КонецПроцедуры

&НаСервере
Функция ра_ПоказатьМаршрутНаСервере()
	БизнесПроцесс = Объект.БизнесПроцесс;
	БПОбъект = БизнесПроцесс.ПолучитьОбъект();
	Возврат БПОбъект.ПолучитьКартуМаршрута();
КонецФункции
