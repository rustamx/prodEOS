...
Процедура УстановитьСведенияДействующегоСогласия()
	...
	ЧастиСообщения.Добавить(СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru = 'У субъекта %1 уже было получено'; en = 'Subject %1 already granted'"), Формат(Согласие.ДатаПолучения, "ДЛФ=D")) + " ");
