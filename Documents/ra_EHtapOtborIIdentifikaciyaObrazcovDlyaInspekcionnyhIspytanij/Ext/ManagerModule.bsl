...
Процедура ДополнитьОписаниеМетаданных(ОбработкаОбъект, Данные, ПараметрыФормирования) Экспорт
	...
	"ProvedenieOtboraObrazcov,
	|SpisokAktov,
	|SpisokAktov.AktOtboraObrazcov,
	|SpisokAktov.DataAktaOtboraObrazcov,
	|SpisokAktov.IspytatelnayaLaboratoriya,
	|SpisokAktov.NomerAktaOtboraObrazcov,
	|SpisokAktov.OtborProizvodilsya", Истина);
