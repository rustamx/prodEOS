...
Процедура ДополнитьОписаниеМетаданных(ОбработкаОбъект, Данные, ПараметрыФормирования) Экспорт
	...
	ОбработкаОбъект.УстановитьВидимость("TaskComment", ЗадачиИДействия.Количество());
	ОбработкаОбъект.УстановитьДоступность("TaskComment", ЗадачиИДействия.Количество());
