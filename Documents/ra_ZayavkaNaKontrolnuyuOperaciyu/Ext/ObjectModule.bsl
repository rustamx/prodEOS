...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	Если ЭтоНовый Тогда
		Если РежимЗаписи = РежимЗаписиДокумента.Проведение Тогда
			//ДополнительныеСвойства.Вставить("Состояние", Перечисления.СостоянияДокументов.ra_НаПодтверждении);
			//ДополнительныеСвойства.Вставить("ОтправитьНаПодтверждение", Zayavitel <> RukovoditelKontrolera);
			ДополнительныеСвойства.Вставить("ОтправитьНаПодтверждение", Истина);
		Иначе
