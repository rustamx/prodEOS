...
Функция ПолучитьМассивКнопок(ДокументОбъект) Экспорт
	...
	Если ВидФормы = "ФормаОбъекта" Тогда
		...
		ЭтоВыявивший = ДокументОбъект.VyyavivsheeLico = Пользователи.ТекущийПользователь();
		ЭтоПолучатель = ДокументОбъект.OtvetstvenniyZaKachestvo = Пользователи.ТекущийПользователь();
		// ТСК Близнюк С.И.; 11.12.2018; task#2117}
...
Процедура АктуализироватьМассивОбязательныхРеквизитов(МассивРеквизитов, ДокументОбъект = Неопределено) Экспорт
	...
	Если ДокументОбъект.OtvetstvenniyZaKachestvo = Пользователи.ТекущийПользователь() Тогда
...
Процедура ДополнитьОписаниеМетаданных(ОбработкаОбъект, Данные, ПараметрыФормирования) Экспорт
	...
	// ТСК Близнюк С.И.; 11.12.2018; task#2117{
	ДоступностьПолучатель = Данные.OtvetstvenniyZaKachestvo = Пользователи.ТекущийПользователь();
