...
Процедура ПередЗаписью(Отказ, ПараметрыЗаписи)
	...
	Если Объект.Ссылка.Пустая()
		...
		ТекстВопроса = НСтр("ru = 'Указаная дата начала брони уже прошла. Забронировать?'; en = 'The specified reservation date has already passed. Reserve anyway?'");
...
Процедура ПометитьНаУдаление(Команда)
	...
	Если Модифицированность = Истина Или (Не ЗначениеЗаполнено(Объект.Ссылка)) Тогда
		...
		ТекстВопроса =
			НСтр("ru = 'Для установки отметки удаления необходимо записать внесенные вами изменения. Записать данные?'; en = 'To mark for deletion you should save changes. Do you want to save changes?'");
...
Процедура УстановитьПодсказкуСпособаВвода()
	...
	Если Объект.СпособСозданияБрони = Перечисления.СпособыСозданияБрони.Автоматически Тогда
		Элементы.Основание.Подсказка = НСтр("ru = 'Бронь введена автоматически.'; en = 'This is an automatic reservation.'");
	...
	ИначеЕсли Объект.СпособСозданияБрони = Перечисления.СпособыСозданияБрони.АвтоматическиУказанПредмет Тогда
		Элементы.Основание.Подсказка = НСтр("ru = 'Предмет брони указан автоматически.'; en = 'Reservation subject was specified automatically.'");
		Элементы.Основание.ОтображениеПодсказки = ОтображениеПодсказки.Кнопка;
	Иначе
