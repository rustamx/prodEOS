...
Процедура ВыбратьРекомендацию()
	...
	Если Элементы.Рекомендации.ТекущаяСтрока <> Неопределено Тогда
		...
		Если ТекущиеДанные = Неопределено Тогда
			ТекстПредупреждения = НСтр("ru = 'Не выбрана рекомендация.'; en = 'The recommendation is not selected.'");
...
Процедура ОбновитьСервер()
	...
	Если КоличествоРекомендаций = 0 Тогда
		...
		Заголовок = НСтр("ru = 'Невозможно забронировать'; en = 'It is impossible to reserve the premises.'");
		Элементы.ДекорацияПредупреждение.Заголовок =
			НСтр("ru = 'Невозможно забронировать, так как есть пересекающиеся брони.'; en = 'It is impossible to reserve the premises because there are overlapping reservations.'");
	ИначеЕсли КоличествоРекомендацийВремени <> 0 И КоличествоРекомендацийПомещений <> 0 Тогда
		Заголовок = НСтр("ru = 'Рекомендации'; en = 'Recommendations'");
		Элементы.ДекорацияПредупреждение.Заголовок =
			НСтр("ru = 'Невозможно забронировать, так как есть пересекающиеся брони. Выберите один из рекомендуемых промежутков времени или помещение.'; en = 'It is impossible to reserve the premises because there are overlapping reservations. Select one of the recoommended time periords or premises.'");
	ИначеЕсли КоличествоРекомендацийВремени <> 0 Тогда
		...
		Элементы.ДекорацияПредупреждение.Заголовок =
			НСтр("ru = 'Невозможно забронировать, так как есть пересекающиеся брони. Выберите один из рекомендуемых промежутков времени.'; en = 'It is impossible to reserve the premise because there are overlapping reservations. Select one of the recoommended time periords.'");
	ИначеЕсли КоличествоРекомендацийПомещений <> 0 Тогда
		...
		Элементы.ДекорацияПредупреждение.Заголовок =
			НСтр("ru = 'Невозможно забронировать, так как есть пересекающиеся брони. Выберите одно из рекомендуемых помещений.'; en = 'It is impossible to reserve the premise because there are overlapping reservations. Select one of the recoommended premises.'");
	КонецЕсли;
