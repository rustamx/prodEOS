...
Функция ПолучитьМассивКолонокСписка(ИмяДок) Экспорт
	
	//МетаданныеДокумента = Метаданные.Документы.ra_EHtapOcenkiSootvetstviyaNaznachenieKomissii;
	МетаданныеДокумента = Метаданные.Документы[ИмяДок];
...
Процедура ДополнитьОписаниеМетаданных(ОбработкаОбъект, Данные, ПараметрыФормирования) Экспорт
	...
	ОбработкаОбъект.УстановитьВидимость(
		"AktyOtboraObrazcov,
		|AktyOtboraObrazcov.AktOtboraObrazcov,
		|AktyOtboraObrazcov.DataAktaOtboraObrazcov,
		|AktyOtboraObrazcov.IspytatelnayaLaboratoriya,
		|AktyOtboraObrazcov.NomerAktaOtboraObrazcov,
		|AktyOtboraObrazcov.OtborProizvodilsya,
		|AktyOtboraObrazcov.ProvedenieOtboraObrazcov", Истина);
