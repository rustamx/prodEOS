...
Процедура ДобавитьВложениеИзФайлаНаДиске(Команда)
	...
	ТекстПредупреждения = НСтр("ru = 'Для загрузки файла необходимо установить расширение для веб-клиента 1С:Предприятие.'; en = 'To download the file one should install the extension for 1C:Enterprise web client'");
