...
Процедура ДополнитьОписаниеМетаданных(ОбработкаОбъект, Данные, ПараметрыФормирования) Экспорт
	...
	"DataDokumentaOProvedeniiKontrolyaSertificirovannojSMK,
	|DokumentOProvedeniiKontrolyaSertificirovannojSMK,
	|NomerDokumentaOProvedeniiKontrolyaSertificirovannojSMK,
	|OrganPoSertifikacii,
	|SertifikatSootvetstviyaSMK", Истина);
