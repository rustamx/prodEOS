...
Функция ПолучитьМассивКолонокСписка() Экспорт
	...
	МетаданныеДокумента = Метаданные.Документы.ra_EHtapOcenkiSootvetstviyaPrinyatieResheniya;
...
Процедура СформироватьМассивДанныхGetList(Результат, ПолноеИмя, ПараметрыЗапросаHTTP) Экспорт
	...
	ОбъектМетаданных = Метаданные.Документы.ra_EHtapOcenkiSootvetstviyaPrinyatieResheniya;
...
Процедура ДополнитьОписаниеМетаданных(ОбработкаОбъект, Данные, ПараметрыФормирования) Экспорт
	...
	"SpisokProtokolov,
	|SpisokAktov.DataAktaOtboraObrazcovIspytuemojProdukcii,
	|SpisokAktov.DataAktaProverkiIspytatelnojLaboratorii,
	|SpisokAktov.DataPolucheniyaIspytuemogoObrazcaProdukcii,
	|SpisokAktov.DataProtokolaIspytanij,
	|SpisokAktov.DataProvedeniyaIspytanij,
	|SpisokAktov.IspytatelnayaLaboratoriyaAkkreditovannayaVOblastiIspolzovaniyaAtomnojEHnergii,
	|SpisokAktov.IspytatelnayaLaboratoriyaAkkreditovannayaVRFIliZarubezhIspytatLaboratoriyami,
	|SpisokAktov.IspytuemayaProdukciya,
	|SpisokAktov.KommentarijKVyvoduPoRezultatamProverkiIspytatelnojLaboratorii,
	|SpisokAktov.KompetentnostRabotnikovIspLaboratoriiProvoditIspytaniyaSertificiruemojProdukcii,
	|SpisokAktov.NalichieDokumentovOpredelyayushchihPravilaVedeniyaZapisejIspytatelnojLaboratorii,
	|SpisokAktov.NalichieUIspytatelnojLaboratoriiMetodikIspytanijSertificiruemojProdukcii,
	|SpisokAktov.NalichieUIspytatelnojLaboratoriiNeobhodimogoIspytatOborudISredstvIzmerenij,
	|SpisokAktov.NomerAktaOtboraObrazcovIspytuemojProdukcii,
	|SpisokAktov.NomerAktaProverkiIspytatelnojLaboratorii,
	|SpisokAktov.NomerAttestataAkkreditaciiIspytatelnojLaboratoriiAkkredVOblIspolAEHnergii,
	|SpisokAktov.NomerAttestataAkkreditaciiIspytatLaboratoriiAkkreditVRFIliZarubezh,
	|SpisokAktov.NomerProtokolaIspytanij,
	|SpisokAktov.PriznanieProvodilos,
	|SpisokAktov.ProvedeniePriznaniyaRezultatovIspytaniya,
	|SpisokAktov.SootvIspytOborudISredstvIzmIspytSertificiruemojProdukciiTrebovaniyamGosSistemy,
	|SpisokAktov.SootvMetodikIspytSertificiruemojProdukciiTrebGosSistemy,
	|SpisokAktov.SootvPomeshchenijVKotoryhBudutOsushchestvIspytSertificiruemojProdukcii,
	|SpisokAktov.VyvodPoRezultatamProverkiIspytatelnojLaboratorii", Истина);
